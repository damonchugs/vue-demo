window.TileBD09Layer = (function() {
    ...
    getViewExtent: function() {
      ...
      var bounds = [
        ...
        transform.pointLocation(
          new lib.Point(transform.width, transform.height)
        ),
  ...
  Tile.prototype = {
    ...
    calcExtent: function() {
      ...
      var swWebgl = mapboxgl.MercatorCoordinate.fromLngLat(
        wgs84Bound.slice(0, 2)
      );
      var neWebgl = mapboxgl.MercatorCoordinate.fromLngLat(
        wgs84Bound.slice(2, 4)
      );
      var seWebgl = mapboxgl.MercatorCoordinate.fromLngLat(
        wgs84Bound.slice(4, 6)
      ); //new mapboxgl.Point(neWebgl.x,swWebgl.y) //
      var nwWebgl = mapboxgl.MercatorCoordinate.fromLngLat(
        wgs84Bound.slice(6, 8)
      ); //new mapboxgl.Point(swWebgl.x,neWebgl.y) //
